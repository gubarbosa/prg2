...
dificuldade = input('Seleciona a dificuldade do jogo! Fácil: 1, Médio: 2, Difícil: 3')
if dificuldade == '1':
    ...
    arquivo = open('palavras1.txt','r', encoding='utf-8')
    linha = open('palavras1.txt').read().splitlines()
    linha_aleatoria = random.choice(linha)
    palavra = "".join(random.sample(linha_aleatoria, len(linha_aleatoria)))
elif dificuldade == '3':
    arquivo = open('palavras2.txt', 'r', encoding='utf-8')
    linha = open('palavras2.txt').read().splitlines()
    linha_aleatoria = random.choice(linha)
    palavra = "".join(random.sample(linha_aleatoria, len(linha_aleatoria)))
